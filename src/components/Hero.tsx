    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Архитектурная студия Hously"}</p>
          ...
          >
            {"Архитектура,"}
            <br />
            <span className="text-orange-200">{"живущая вечно"}</span>
          </h1>
        </div>
      </div>
